...
export type SessionExportResponse = SessionExportSuccessSchema | SystemHelloFailureSchema;
...
export interface SessionExportSuccessSchema {
  id: RpcIdSchema;
...
export interface SessionExportResult {
  events: TestEvent[];
  nextAfterSequence?: EventSequence | null;
  session: SessionInfo;
}
