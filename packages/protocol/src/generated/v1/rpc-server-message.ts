...
export type RpcServerMessage = RpcResponseSchema | RpcServerNotification;
export type RpcResponseSchema = RpcSuccessSchema | RpcFailureSchema;
...
export type RpcServerNotification =
  EventsStreamEventNotification | EventsStreamTerminalNotification;
export type EventsStreamEventMethod = "events.stream.event";
/**
...
export interface EventsStreamEventNotification {
  jsonrpc: JsonRpcVersion;
  method: EventsStreamEventMethod;
  params: EventsStreamEventParams;
}
export interface EventsStreamEventParams {
