...
# Source: protocol/schema/v1/session-end-response.schema.json
...
class SessionEndSuccessSchema(TypedDict):
    id: RpcIdSchema
...
SessionEndResponse: TypeAlias = SessionEndSuccessSchema | SystemHelloFailureSchema
