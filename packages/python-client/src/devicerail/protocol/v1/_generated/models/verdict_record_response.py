...
# Source: protocol/schema/v1/verdict-record-response.schema.json
...
class VerdictRecordResult(TypedDict):
    event: TestEvent

class VerdictRecordSuccessSchema(TypedDict):
    id: RpcIdSchema
    jsonrpc: JsonRpcVersion
    result: VerdictRecordResult
...
VerdictRecordResponse: TypeAlias = VerdictRecordSuccessSchema | SystemHelloFailureSchema

__all__ = ['VerdictRecordResponse']
