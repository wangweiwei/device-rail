...
# Source: protocol/schema/v1/device-connect-response.schema.json

class DeviceConnectSuccessSchema(TypedDict):
    id: RpcIdSchema
...
DeviceConnectResponse: TypeAlias = DeviceConnectSuccessSchema | SystemHelloFailureSchema

__all__ = ['DeviceConnectResponse']
