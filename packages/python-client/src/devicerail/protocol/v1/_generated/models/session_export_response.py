...
# Source: protocol/schema/v1/session-export-response.schema.json
...
class SessionExportResult(TypedDict):
    ...
    nextAfterSequence: NotRequired[EventSequence | None]
    session: SessionInfo

class SessionExportSuccessSchema(TypedDict):
    id: RpcIdSchema
...
SessionExportResponse: TypeAlias = SessionExportSuccessSchema | SystemHelloFailureSchema

__all__ = ['SessionExportResponse']
