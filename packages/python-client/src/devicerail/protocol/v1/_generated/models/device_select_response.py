...
# Source: protocol/schema/v1/device-select-response.schema.json
...
class DeviceSelectSuccessSchema(TypedDict):
    id: RpcIdSchema
...
DeviceSelectResponse: TypeAlias = DeviceSelectSuccessSchema | SystemHelloFailureSchema

__all__ = ['DeviceSelectResponse']
