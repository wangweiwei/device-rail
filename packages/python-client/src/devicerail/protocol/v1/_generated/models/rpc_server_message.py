...
# Source: protocol/schema/v1/rpc-server-message.schema.json
...
class EventsStreamEventNotification(TypedDict):
    jsonrpc: JsonRpcVersion
    method: EventsStreamEventMethod
...
class EventsStreamTerminalNotification(TypedDict):
    jsonrpc: JsonRpcVersion
...
EventsStreamEventMethod: TypeAlias = Literal['events.stream.event']

EventsStreamTerminalMethod: TypeAlias = Literal['events.stream.terminal']
...
RpcResponseSchema: TypeAlias = RpcSuccessSchema | RpcFailureSchema

RpcServerNotification: TypeAlias = EventsStreamEventNotification | EventsStreamTerminalNotification
...
RpcServerMessage: TypeAlias = RpcResponseSchema | RpcServerNotification

__all__ = ['RpcServerMessage']
