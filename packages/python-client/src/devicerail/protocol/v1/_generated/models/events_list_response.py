...
# Source: protocol/schema/v1/events-list-response.schema.json
...
class EventsListSuccessSchema(TypedDict):
    id: RpcIdSchema
    jsonrpc: JsonRpcVersion
    result: list[TestEvent]
...
EventsListResponse: TypeAlias = EventsListSuccessSchema | SystemHelloFailureSchema
